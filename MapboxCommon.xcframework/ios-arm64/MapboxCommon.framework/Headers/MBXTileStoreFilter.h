...
/**  Exclude unavailable tiles (tiles that are not downloaded or failed to download) from the result set. */
- (nonnull MBXTileStoreFilter *)excludeUnavailable __attribute((ns_returns_retained));
